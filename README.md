...
- **Animations:** [Motion](https://motion.dev/) – A powerful JavaScript library for high-performance animations.
...
🎨 Built with passion using Next.js, Tailwind CSS, and Motion!
